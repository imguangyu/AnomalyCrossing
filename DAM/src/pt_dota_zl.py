...
def pretext_train_ssl(args, recorder):
    ...
    train_transforms, test_transforms, eval_transforms = pt_augmentation_config(args, recorder)
    ...
    for epoch in range(args.pt_start_epoch, args.pt_epochs + 1):
        ...
        state = {
            'opt': args,
            'state_dict_encoder': model_without_dp.encoder.state_dict(),
            'state_dict_head': model_without_dp.id_head.state_dict(),
