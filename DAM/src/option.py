...
# ============================================== global setting =====================================
parser.add_argument('--method', type=str, default='pt_and_ft', choices=['pt', 'ft', 'pt_and_ft','ssl'], help='pretrain or fine_tune or together')
parser.add_argument('--status', type=str, default='pt', choices=['pt', 'ft'], help='pretrain or fine_tune')
parser.add_argument('--arch', default='r2p1d_lateTemporal', type=str, choices=['i3d', 'r3d18', 'r3d34', 'r3d50', 'r2p1d', 'c3d', 's3d','r2p1d_lateTemporal'])
parser.add_argument('--gpus', type=str, default="0", help="define gpu id")
parser.add_argument('--device', default='cuda', help='device to be used, cuda or cpu')
...
parser.add_argument('--pt_batch_size', type=int, default=1, help='batch_size')
parser.add_argument('--pt_workers', type=int, default=1, help='num of workers to use')
parser.add_argument('--pt_epochs', type=int, default=10, help='number of training epochs')
...
parser.add_argument('--pt_data_length', default='32', help='input clip length')
parser.add_argument('--pt_clips', default='4', help='global local clips num')
parser.add_argument('--pt_flow_prefix', default="", type=str)
parser.add_argument('--pt_time_thresh', default=2, type=int, help='time distance theshold for DSM')
...
parser.add_argument('--ssl_width', default=1, type=int)
parser.add_argument('--ssl_height', default=1, type=int)
parser.add_argument('--ssl_min_len', default=20, type=int, 
                    help='minimum length of the loaded clips')
parser.add_argument('--ssl_load_model', action='store_true',  
                   help='load save model for dota')
parser.add_argument('--freeze_backbone', action='store_true',  
                   help='freeze the backbobe network or not')
...
# dataset
parser.add_argument('--pt_dataset', type=str, default='dota', choices=['hmdb51', 'ucf101', 'kinetics', 'diving48', 'sth_v1','dota', 'bdd', 'ucf_crime','paper_fold'])
...
# dataset setting
parser.add_argument('--pt_train_list', type=str, default='../datasets/settings/dota_seq/train_rgb_split1.txt')
parser.add_argument('--pt_val_list', type=str, default='../datasets/settings/dota_seq/val_rgb_split1.txt')
...
args = parser.parse_args()#args=['--method','dota']