...
model_urls = {
    # 'r2plus1d_18_xdc_igk':'https://github.com/HumamAlwassel/XDC/releases/download/model_weights/r2plus1d_18_xdc_ig65m_kinetics-f24f6ffb.pth',
...
# def r2plus1d_18_xdc_igk(pretrained=False, progress=True, **kwargs):
#     """Constructor for the 18 layer deep R(2+1)D network as in
#     https://arxiv.org/abs/1711.11248
#     Args:
#         pretrained (bool): If True, returns a model pre-trained on Kinetics-400
